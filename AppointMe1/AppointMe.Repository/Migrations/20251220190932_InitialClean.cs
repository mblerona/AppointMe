        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultSlotMinutes = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    EnableServices = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    EnableStaffing = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceOfferings_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentServices", x => new { x.AppointmentId, x.ServiceOfferingId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentServices_ServiceOfferings_ServiceOfferingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointment_TenantId_AppointmentDate",
                table: "Appointments",
                columns: new[] { "TenantId", "AppointmentDate" });

            migrationBuilder.CreateIndex(
                name: "IX_Appointment_TenantId_CustomerId",
                table: "Appointments",
                columns: new[] { "TenantId", "CustomerId" });

            migrationBuilder.CreateIndex(
                name: "IX_Appointment_TenantId_Status",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentServices_ServiceOfferingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointMeAppUser_TenantId",
                table: "AspNetUsers",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customer_TenantId_CustomerNumber",
                table: "Customers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customer_TenantId_FirstName",
                table: "Customers",
                columns: new[] { "TenantId", "FirstName" });

            migrationBuilder.CreateIndex(
                name: "IX_Customer_TenantId_LastName",
                table: "Customers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceCategory_BusinessId_Name",
                table: "ServiceCategories",
                columns: new[] { "BusinessId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ServiceOffering_BusinessId_Name",
